...
-- fichero bd1-p3-revistas-insert.sql
-- Kateryna Pasternak y IVAN ANDRES YAGUAL MENDEZ
---------------------------------------------------------------------------------
--INSERCION de datos en LAS TABLAS DEL ESQUEMA "REVISTAS"
--No se ha incluido tildes para evitar problemas de codificacion de caracteres --
---------------------------------------------------------------------------------

/*****************************************************************************
** La ejecucion de las sentencias INSERT tal y como estan, da ERROR.        **
** ES NECESARIO RESOLVER LOS PROBLEMAS debidos a tipos de datos, longitud   **
** de columnas, y por supuesto a la integridad referencial (claves ajenas:  **
** orden de insercion de filas en las tablas y ciclo referencial)           **
** Mas Informacion en el enunciado de la practica P3 (ejercicios 0 y 1)     **
******************************************************************************/

-- Sentencias DELETE, para la ejecucion repetida de este script, mientras se depura
...
-- --> incluir aqui, en orden inverso al de insercion/creacion
